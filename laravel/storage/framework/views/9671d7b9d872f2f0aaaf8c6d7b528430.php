                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="javascript:;" target="_blank" style="text-decoration:none;display: block;">
                                                            <h1 style="color: white; text-align:center;"><?php echo e(env('APP_NAME')); ?></h1>
                                                        </a>
                                                    </td>
                                                </tr>
                                            </table>
                                                    ...
                                                    <td>
                                                        <div style="display: block">
                                                            <p style="font-family: 'Work Sans';font-size:14px;font-weight: 400;line-height: 20px;color: #292929;margin:0;margin-bottom: 10px;"> Dear
                                                                    ...
                                                                    <strong><?php echo e($mailData['name']); ?>,</strong></p>
                                                            ...
                                                            <p style="font-family: 'Work Sans';font-size:14px;font-weight: 400;line-height: 20px;color: #292929;margin:0;margin-bottom: 10px;"><b><u><a href="<?php echo e($mailData['url']); ?>" target="_blank">Link</a></u></b></p>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        <td width="100%" style="padding-bottom: 40px;">
                                            <div>
                                                ...
                                                <h3 style="font-family: 'Work Sans';font-size:14px;font-weight:600;line-height: 20px;color: #292929;margin:0;"><strong> <?php echo e(env('APP_NAME')); ?> Team </strong></h3>
                                            </div>
                                        </td>
                                    </tr>
...
<?php /**PATH /var/www/html/iwin/resources/views/emails/activation_link.blade.php ENDPATH**/ ?>