<nav class="navbar navbar-expand-lg">
  <div class="container-fluid">
    ...
    <div class="desktop-profile px-3  flex-lg-row flex-column align-items-center gap-3">
      ...
      <img src="<?php echo e(asset('front/images/welcomegraphic.gif')); ?>" alt="">
    </div>
    </div>
      ...
      <div class="offcanvas-body align-items-baseline">
        ...
        <div class="mobile-menu">
          ...
          <ul class="navbar-nav ms-lg-auto ms-md-0 align-align-items-lg-center">
            ...
            <li class="nav-item"><a href="<?php echo e(route('front.cmsPages',['terms-of-use'])); ?>">TERMS OF USE</a></li>
            <li class="nav-item"><a href="<?php echo e(route('front.cmsPages',['privacy-policy'])); ?>">PRIVACY POLICY</a></li>
          </ul>
...
</nav><?php /**PATH /var/www/html/iwin/resources/views/front/partials/header.blade.php ENDPATH**/ ?>