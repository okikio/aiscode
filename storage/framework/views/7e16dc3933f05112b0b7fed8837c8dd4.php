...
<head>
  ...
  <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-3TP7NBM8MQ"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'G-3TP7NBM8MQ');
</script>
...
</html><?php /**PATH /var/www/html/iwin/resources/views/front/layouts/main.blade.php ENDPATH**/ ?>