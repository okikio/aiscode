                                    ...
                                    <tr>
                                        <td align="center" style="padding-top: 40px;padding-bottom: 40px;">
                                            <div style="display: block">
                                                <h1 style="font-family: 'Work Sans';font-size:22px;font-weight: 700; color: #000000;margin:0;">Reset Password Success Mail</h1>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div style="display: block">
                                                            ...
                                                            <p style="font-family: 'Work Sans';font-size:14px;font-weight: 400;line-height: 20px;color: #292929;margin:0;margin-bottom: 10px;">You are changed your password succeful.</p>
                                                            <p style="font-family: 'Work Sans';font-size:14px;font-weight: 400;line-height: 20px;color: #292929;margin:0;margin-bottom: 10px;">If you did change password, no further action is required.</p>
                                                            <p style="font-family: 'Work Sans';font-size:14px;font-weight: 400;line-height: 20px;color: #292929;margin:0;margin-bottom: 10px;">If you did not change password, protect your account.</p>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
